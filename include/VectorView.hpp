...
public:
    ...
    public:
        ...
        inline auto operator*() { return UnaryOp()(*original); }
        ...
        inline auto operator->() { return original; }

        inline auto operator-(int x) const { return custom_const_iterator(original - x); }

        inline auto operator-(custom_const_iterator x) const { return original - x.original; }

        inline auto operator!=(custom_const_iterator x) { return x.original != original; }
    ...
    inline auto begin() const { return custom_const_iterator(first); }

    inline auto end() const { return custom_const_iterator(last); }
